...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`companyID`)
	VALUES ('cprg352+barb@gmail.com', true, 'Barb','Barber', 'password', 2,4);

INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (2, 'blender',29.99,'cprg352+anne@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (3, 'toaster',19.99,'cprg352+anne@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (4, 'lamp',5,'cprg352+barb@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (5, 'winter tires',200,'cprg352+admin2@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (6, 'dresser',50,'cprg352+admin@gmail.com');

INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (7, 'blender',29.99,'cprg352.test.sait+admin@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (6, 'Comb',19.99,'cprg352.test.sait+barb@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (5, 'Tissue',5,'cprg352.test.sait+anne@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (4, 'desk',200,'cprg352.test.sait+admin2@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (1, 'table',50,'cprg352.test.sait+anne@gmail.com');

INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (2, 'blender1',29.99,'cprg352+anne@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (3, 'toaster1',19.99,'cprg352+anne@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (4, 'lamp1',5,'cprg352+barb@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (5, 'winter1 tires',200,'cprg352+admin2@gmail.com');
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (6, 'dresser1',50,'cprg352+admin@gmail.com');